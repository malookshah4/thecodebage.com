...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy for thecodebage and Remote Mouse Pro. LAN-only operation, no analytics, no tracking, no third-party SDKs.",
};
    ...
    <article className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
      ...
      <div className="prose prose-zinc max-w-none text-zinc-700 [&_h2]:mt-12 [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:tracking-tight [&_h2]:text-zinc-900 [&_h3]:mt-8 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-zinc-900 [&_p]:mt-4 [&_p]:leading-relaxed [&_ul]:mt-4 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-2 [&_li]:leading-relaxed [&_a]:text-primary [&_a]:underline [&_a]:underline-offset-2 hover:[&_a]:text-primary/80 [&_strong]:font-semibold [&_strong]:text-zinc-900">
        <p>
          ...
          Windows server (collectively, the &ldquo;Service&rdquo;), and the website at{" "}
          <a href="https://thecodebage.com">thecodebage.com</a>.
        </p>
        <p>
        ...
        <h2>6. Website (thecodebage.com)</h2>
        <p>
          This website is hosted on Cloudflare. Cloudflare may automatically log
          standard server data (IP address, user agent, request URL, timestamp) for
          basic security and abuse prevention. We do not place any analytics, tracking,
          or advertising scripts on this site.
        </p>
        ...
        <p>
          ...
          the Service after the change is acceptance of the revised policy.
        </p>
