...
const FEATURES = [
  ...
  {
    title: "OCR text scan",
    body: "Point at any printed text — book page, screen, sticky note — and Remote Mouse Pro extracts it on-device and pastes it on your PC.",
  },
  {
...
const FAQ = [
  {
    ...
    a: "No. Remote Mouse Pro works entirely over your local Wi-Fi network. Nothing flows through our servers — we don't run any.",
  },
  {
